<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="leaderboardApp()" x-init="getLeaderboardData()">
...
<body class="min-h-screen bg-gray-50 p-8">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-wrap justify-between items-center mb-6 gap-4">
            ...
            <div class="flex items-center gap-2">
                <select x-model="filter" @change="getLeaderboardData()" class="border p-2 rounded">
            ...
            <div class="flex items-center gap-2">
                <input type="text" x-model="search" @input="handleSearch" placeholder="Search User Id, Name" class="border p-2 rounded">
            </div>
    ...
    <script>
        function leaderboardApp() {
            const leaderboardUrl = "{{ route('leaderboard') }}";
            const RecalculateUrl = "{{ route('leaderboard.recalculate') }}";
            ...
            return {
                ...
                getLeaderboardData() {
                    ...
                    this.loading = true;
                    fetch(`${leaderboardUrl}?filter=${this.filter}&search=${this.search}`, {
